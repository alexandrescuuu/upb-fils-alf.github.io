...
## Conseils
1. Lisez les types possibles d’erreurs dans le [repository des testes](https://github.com/UPB-FILS-ALF/devoir-4-tests) pour voir exactement les cas que vous devez traiter.
